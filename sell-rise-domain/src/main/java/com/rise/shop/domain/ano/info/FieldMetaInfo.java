package com.rise.shop.domain.ano.info;
 ...
 */
public class FieldMetaInfo implements Comparable<FieldMetaInfo> {
    ...
    public FieldMetaInfo(String fieldName, String genericType, FieldMeta meta) {
